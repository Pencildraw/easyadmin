        ...
        index: function () {
            ea.table.render({
                ...
                cols: [[
                    ...
                    {field: 'order_amount', title: '订单金额' ,search:'false', templet: ea.table.price},
                    {field: 'ok_amount', title: '已支付金额' ,search:'false', templet: ea.table.price},
